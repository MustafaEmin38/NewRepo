...
public class C04_NestedIf {
    public static void main(String[] args) {
       ...
       /* Scanner scan=new Scanner(System.in);
        ...
        /*
        Kullanıcıdan sisteme bir numara girmesini isteyin.
        1.Eger numara sıfırdan küçükse, konsolda "Negatif Sayı" yazdırın.
        2.Degilse, 10'dan küçük olup olmadığına bakın. 10'dan küçükse konsola "Rakam" yazdırın,
        3.10'dan büyük veya eşitse konsola "Pozitif Sayı" yazdırın.
        */
